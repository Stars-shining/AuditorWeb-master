...
public class Question : IHttpHandler, IRequiresSessionState
{
    ...
    public void SaveUploadStartInfo()
    {
        ...
        APQuestionnaireResultsDO resultsDO = APQuestionnaireManager.GetQuestionnaireResultDOByDeliveryIDAndClientID(_deliveryID, _clientID);
    ...
    public void GetQ1ForUpload()
    {
        ...
        try
        {
            ...
            jsonQuestionPath = jsonQuestionPath.Replace("\\", "\\\\");
        }
        catch { }
    ...
    public void GetQuestionnaireAnswers()
    {
        ...
        if (_bOnlyDeduction == true) 
        {
            ...
            APQuestionnaireResultsDO resultDO = APQuestionnaireManager.GetQuestionnaireResultDOByID(_resultID);
            if (resultDO.Status == (int)Enums.QuestionnaireStageStatus.复审中 || resultDO.Status == (int)Enums.QuestionnaireStageStatus.完成)
            {
