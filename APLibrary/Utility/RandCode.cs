...
namespace APLibrary
{
    ...
    public class YZMHelper
    {
        ...
        private int letterWidth = 28;  //单个字体的宽度范围
        private int letterHeight = 48; //单个字体的高度范围
        private static byte[] randb = new byte[4];
        private static RNGCryptoServiceProvider rand = new RNGCryptoServiceProvider();
        private Font[] fonts = 
    {
       new Font(new FontFamily("Times New Roman"),20 +Next(1),System.Drawing.FontStyle.Regular),
       new Font(new FontFamily("Georgia"), 20 + Next(1),System.Drawing.FontStyle.Regular),
       new Font(new FontFamily("Arial"), 20 + Next(1),System.Drawing.FontStyle.Regular),
       new Font(new FontFamily("Comic Sans MS"), 20 + Next(1),System.Drawing.FontStyle.Regular)
    };
        #endregion
